    ...
    .end(function(err, res) {
        ...
        if (typeof deps !== "undefined") {
            Object.keys(deps).forEach(function (dep) {
                (function () {
                    request
                        .get('https://brewweb.devel.redhat.com/search?match=glob&type=package&terms=nodejs010-nodejs-' + dep)
                        .end(function (err, res) {
                            //console.log(err);
        ...
        if (typeof devDeps !== "undefined") {
            Object.keys(devDeps).forEach(function (devDep) {
                var url = 'https://brewweb.devel.redhat.com/search?match=glob&type=package&terms=nodejs010-nodejs-' + devDep;
                (function () {
                    request
                        .get(url)
                        .end(function (err, res) {
